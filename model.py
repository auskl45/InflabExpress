...
#Envios
class Envios(db.Model, RoleMixin):
    id= db.Column(db.Integer, primary_key=True)
    idPedido = db.Column(db.Integer())
    fechaEnvio = db.Column(db.DateTime())
    fechaEntrega = db.Column(db.DateTime())
    proveedorEnvio = db.Column(db.String(255))
    noSeguimiento = db.Column(db.String(255))
    estatus = db.Column(db.Integer()) #1=Enviado, 2=Entregado, 0=Cancelado
...
class Pedido(db.Model):
    ...
    estatusPedido = db.Column(db.Integer()) #1=pendiente, 2=en procesos, 3=realizado
